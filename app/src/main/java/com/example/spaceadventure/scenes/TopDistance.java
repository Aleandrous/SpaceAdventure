...
public class TopDistance extends SceneFW {
    ...
    public void drawing() {
        ...
        graphicFW.drawText(String.valueOf(numbers[0]), 120, 250, Color.GREEN, 35,null);
        graphicFW.drawText(String.valueOf(numbers[1]), 120, 300, Color.GREEN, 35,null);
        graphicFW.drawText(String.valueOf(numbers[2]), 120, 350, Color.GREEN, 35,null);
        graphicFW.drawText(String.valueOf(numbers[3]), 120, 400, Color.GREEN, 35,null);
        graphicFW.drawText(String.valueOf(numbers[4]), 120, 450, Color.GREEN, 35,null);
